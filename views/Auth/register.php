...
<body class="h-full">
  <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
      <img src="<?= urlpath('public/contact.png')?>" class="w-42" alt="Logo">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      <form class="space-y-6" action="<?= urlpath('register') ?>" method="POST">
        ...
        <div>
          ...
          <div class="mt-2">
            <input id="email" name="email" type="email" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-[#8a4647] focus:ring-2 focus:ring-inset focus:ring-[#8a4647] sm:text-sm sm:leading-6">
          </div>
        </div>
        ...
        <div>
          ...
          <div class="mt-2">
            <input id="password" name="password" type="password" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-[#8a4647] focus:ring-2 focus:ring-inset focus:ring-[#8a4647] sm:text-sm sm:leading-6">
          </div>
        </div>
      ...
      <p class="mt-10 text-center text-sm text-gray-500">
        Already a member?
        <a class="font-semibold leading-6 text-[#8a4647] hover:text-[#aa4647]" href="<?= urlpath('login') ?>">Log in Now!</a>
      </p>
    </div>
  </div>
