        ...
        <div class="flex w-full flex-col px-6 py-12 lg:px-8">
            ...
            <form class="space-y-6" action="<?= urlpath('edit') ?>" method="POST" enctype="multipart/form-data">
                <div>
                    ...
                    <div class="mt-2">
                        <input id="phone_number" name="phone_number" type="text" value="<?php echo $contacts['phone_number']; ?>" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-[#8a4647] focus:ring-2 focus:ring-inset focus:ring-[#aa4647] sm:text-sm sm:leading-6">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input id="owner" name="owner" type="text" value="<?php echo $contacts['owner']; ?>" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-[#8a4647] focus:ring-2 focus:ring-inset focus:ring-[#aa4647] sm:text-sm sm:leading-6">
                    </div>
                </div>
